...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default='search/bs120-dim160', help='experiment name')
    parser.add_argument('--gpu_ids', type=str, default='0', help='visible GPU ids')
    parser.add_argument('--num_workers', type=int, default=32, help='number of cpu threads to use during batch generation')
    ...
    parser.add_argument('--gf_dim', type=int, default=160, help='base channel-dim of G')
    parser.add_argument('--df_dim', type=int, default=80, help='base channel-dim of D')
    ...
    parser.add_argument('--derive_per_epoch', type=int, default=16, help='number of deriving per epoch')
